...
public class BooksViewModel {
    ...
    func getData(){
        ...
        let fairyTales = Books(name: "Fairy Tales", description: "All the best-loved fairy tales of Hans Christian Andersen, including 'The Ugly Duckling,' 'Thumbelina,' 'The Red Shoes,' 'The Princess on the Pea,' and 'The Emperor’s New Clothes,' fill the pages of this beautiful leather-bound collector’s edition", author: "Hans C. Andersen", image: "fairy", details: "Nordican Leyends", aboutAuthor: "was a Danish author. Although a prolific writer of plays, travelogues, novels, and poems, he is best remembered for his literary fairy tales.", categories: "Tales", imageAuthor: "hans")
        
        let Tales = Category(name: "Tales", books: [talesAndPoems, fairyTales])
        
        // MARK: - literatura
        let heights = Books(name: "Wuthering Heights", description: "Catherine and Heathcliff's, a foundling adopted by Catherine's father, passionate but doomed love forms the core of this extraordinary tale. Catherine's brother Hindley's hatred and humiliation of Heathcliff leads to tragedy when Catherine marries another and Heathcliff returns newly wealthy to enact his revenge on all who wronged him.", author: "Emily Brontë", image: "heights", details: "British Literature", aboutAuthor: "Emily Brontë, in full Emily Jane Brontë, pseudonym Ellis Bell, (born July 30, 1818, Thornton, Yorkshire, England—died December 19, 1848, Haworth, Yorkshire), English novelist and poet who produced but one novel, Wuthering Heights (1847), a highly imaginative work of passion and hate set on the Yorkshire moors", categories: "Literature", imageAuthor: "emily")
